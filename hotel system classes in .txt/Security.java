...
public class Security   extends  JFrame {
    ...
    //___________________________________________________________________________
      public Security() throws Exceptions {
         
        final JFrame frame = new JFrame("Security");
        final JTable table = new JTable(); 
        
        
        try{
           
         BufferedImage myImage = ImageIO.read(new File("C:\\Users\\pc\\Desktop\\f-1.jpg"));
...
//                   model.setValueAt(r1.getText(), i, 4);
//                   model.setValueAt(r2.getText(), i, 5);
...
private class Save implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
            ...
            try {
                li.add(em);
                bin = new ObjectOutputStream(new FileOutputStream("Security.txt"));
                bin.writeObject(li.add(em));
                bin.close();
