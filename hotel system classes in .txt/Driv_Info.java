...
import hotelsystem.newpackage.Contact_of_Driver;
 ...
 * @author pc
 */
public class Driv_Info   extends  JFrame {
 ...
 final JComboBox Combo1 = new JComboBox(new String []{"select","Male","Famle"});
       ArrayList <Contact_of_Driver> Contact_of_Driver = new ArrayList<>();
        Contact_of_Driver m=new Contact_of_Driver();
        JPanel p = new JPanel();
       JComboBox Age;
    //___________________________________________________________________________
      public Driv_Info() throws Exceptions {
         
        final JFrame frame = new JFrame("Driv_Info");
        
        
           try{
           
         BufferedImage myImage = ImageIO.read(new File("C:\\Users\\pc\\Desktop\\1140-distracted-driving-tips-intro.imgcache.revc3146837140ff361f2e7651d97e0a010.web.jpg"));
       ...
       LabelId.setBounds(5, 220, 100, 25);
        ...
        LabeltextAge.setBounds(5, 310, 100, 25);
         LabeltextSearch.setBounds(5, 400, 100, 25);
        LabeltextGeneder.setBounds(5, 355, 100, 25);
        // create JButtons
        ...
        textSearch.setBounds(150, 400, 100, 25);
         Combo1.setBounds(150, 355, 100, 25);
        
        btnAdd.setBounds(300, 220, 100, 25);
        btnUpdate.setBounds(300, 265, 100, 25);
        btnDelete.setBounds(300, 310, 100, 25);
        btnSearch.setBounds(300, 400, 100, 25);
...
//            r2.setText(model.getValueAt(i, 5).toString());
        ...
        btnUpdate.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    Choose_User choose_User = new Choose_User();
...
btnSave.addActionListener(new Save());
	...
	public void actionPerformed(ActionEvent arg0) {
            m.Combo1=(String) Combo1.getSelectedItem();
  ...
  private class SaveId implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
       ...
       private class Savefn implements ActionListener {
        ...
        @Override
	public void actionPerformed(ActionEvent arg0) {
            m.First_Name=textFname.getText();
	...
	public void actionPerformed(ActionEvent arg0) {
        ...
        @Override
	public void actionPerformed(ActionEvent arg0) {
            m.Age=(String) Age.getSelectedItem();
...
private class Save implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
            ...
            try {
                Contact_of_Driver.add(m);
                bin = new ObjectOutputStream(new FileOutputStream("Driv_Info.txt"));
                bin.writeObject(Contact_of_Driver.add(m));
                bin.close();
