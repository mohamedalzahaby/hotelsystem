...
public class IT   extends JFrame {
 final JTextField textId = new JTextField();
    ...
    //___________________________________________________________________________
      public IT() throws Exceptions {
         
           
        final JFrame frame = new JFrame("IT");
        
        
         try{
           
       BufferedImage myImage = ImageIO.read(new File("C:\\Users\\pc\\Desktop\\it-guy-in-server-room.jpg"));
...
private class Save implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
            ...
            try {
                l.add(em);
                bin = new ObjectOutputStream(new FileOutputStream("IT.txt"));
                bin.writeObject(l.add(em));
                bin.close();
