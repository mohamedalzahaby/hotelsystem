...
import hotelsystem.newpackage.Contact_of_Guest;
...
public class GuestInfo   extends  JFrame {
    ...
    //___________________________________________________________________________
      public GuestInfo() throws Exceptions{
        ...
        try{
          ...
          BufferedImage myImage = ImageIO.read(new File("C:\\Users\\pc\\Desktop\\what-are-your-rights-as-a-hotel-guest.jpg"));
        ...
        btnUpdate.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(i >= 0) 
                {
                  ...
                  model.setValueAt(Combo.getSelectedItem(), i, 6);
                    model.setValueAt(Combo1.getSelectedItem(), i, 7);
                     model.setValueAt(Adult.getSelectedItem(), i, 8);
                    model.setValueAt(Child.getSelectedItem(), i, 9);
////                   row[8] = Adult.getSelectedItem();
//                    row[9] = Child.getSelectedItem();
                }
