...
//       public Check_In_Out_Date() throws IOException 
//       {
...
//        Container x = tableD.getTableHeader();
//
...
////     
////    // create a table model and set a Column Identifiers to this model
////    Object [] columnsG = {"Check In Date","Check Out Date" , "Number of Nights"};
...
////        NoOfNights=new JTextField();
////
////
////        CheckInDate.setBounds(100, 220, 100, 25); 
////        CheckOutDate.setBounds(105, 300, 100, 25);
////        NoOfNights.setBounds(330, 260, 100, 25);
////
////
////        btnNights = new JButton("No. Nights");
////        btnAdd = new JButton("Add");
...
////        btnUpdate = new JButton("Update");     
////        
////        btnNights.setBounds(200, 260, 110, 25);
////        btnAdd.setBounds(550, 220, 100, 25);
////        btnUpdate.setBounds(550, 265, 100, 25);
////        btnDelete.setBounds(550, 310, 100, 25);
////             
////        JScrollPane pane = new JScrollPane(tableD);
////        pane.setBounds(0, 0, 880, 200);
////        
...
////             
////             //Add JTextField to the jframe
////             frameD.add(CheckInDate);
////             frameD.add(CheckOutDate);
////             frameD.add(NoOfNights);
////             
...
////            public void actionPerformed(ActionEvent e) 
////            {
////              row[0] = CheckInDate.getText();
////              row[1] = CheckOutDate.getText();
////           
////                // add row to the model
////                modelG.addRow(row);
////            }
...
////                   SimpleDateFormat myFormat = new SimpleDateFormat("dd/MM/yyyy");
////                 //  String str;
////	           String InDateString = CheckInDate.getText();
////	      String OutDateString = CheckOutDate.getText();
////              String Nights;
////               String year = "1/1/2017";
////   
////              
...
////               else
////               {
////                    Nights= NoOfNights.getText()+ daysBetween;
////                    NoOfNights.setText(String.valueOf(Nights));
////                    row[2] = NoOfNights.getText();
////                    needed = Integer.parseInt(Nights);
////                    
////               }
////               
////	 } catch (Exception e) 
...
////                if(i >= 0) 
////                {
////                   modelG.setValueAt(CheckInDate.getText(), i, 0);
////                   modelG.setValueAt(CheckOutDate.getText(), i, 1);
//////                   if (btnUpdate.equals(NoOfNights.getText()))
//////                   {
//////                       JOptionPane.showMessageDialog(null,"you can't update number of night","error",JOptionPane.ERROR_MESSAGE);
//////                   }
